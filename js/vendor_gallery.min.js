...
window.onfocus=function(){document.title=currentTitle;}};_Blog.toggleTheme=function(){const currentTheme=window.localStorage&&window.localStorage.getItem('theme');const isDark=currentTheme==='dark';$('body').toggleClass('dark-theme',isDark)
console.log("toggleTheme",isDark);$('.theme-switch').on('click',()=>{const currentTheme=window.localStorage?window.localStorage.getItem('theme'):'light';const isDark=currentTheme!=='dark';$('body').toggleClass('dark-theme',isDark)
